...
namespace OAuth.Tests
{
    ...
    public class WebUtilsTest
    {
        ...
        [TestCase("https://www.google.com/?a=b&c=d&e=f&",4)]
        ...
        [TestCase("https://www.url..com")]
        [TestCase("https://www.google.com/?")]
        public void ParseQueryStringThrowsForInvalidQueryString(string invalidUrl)
        {
            // ReSharper disable once ReturnValueOfPureMethodIsNotUsed
            Assert.Throws<UriFormatException>(() => WebUtils.ParseQueryString(new Uri(invalidUrl)).ToList());
        }
